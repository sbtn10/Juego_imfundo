...
function validarRespuesta(contenedor, botonId) {
    ...
    if (Array.isArray(botonCorrecto)) {
        ...
        if (botonCorrecto.includes(botonId)) {
            ...
            // Realiza acciones si la respuesta es incorrecta
            handleRespuestaIncorrecta(botonId);
        }
    } else {
...
function obtenerBotonCorrecto(contenedorId) {
    switch (contenedorId) {
        case 'contenedor1':
            return 'boton3';
        case 'contenedor2':
            return 'boton2'; // Devuelve un arreglo con ambas opciones
        case 'contenedor3':
            return ['boton1', 'boton4'];
        case 'contenedor4':
            return 'boton5'; // Devuelve un arreglo con ambas opciones
        case 'contenedor5':
            return ['boton1', 'boton4'];
        default:
            return null;
